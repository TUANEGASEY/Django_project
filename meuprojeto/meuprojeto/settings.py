...
SECRET_KEY = 'django-insecure-0s3lseefe%pad1i%zrux0naq9(yu*%r6li1%q48^t6(ued(64='
...
INSTALLED_APPS = [
    ...
    'meuapp',  # <--- Certifique-se de que sua aplicação está aqui
]
